...
class DoubanSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        for movie in movies:
            ...
            item['kind'] = kind[4].extract()
            item['time'] = time[1].extract()
            yield item
            # print('-----------')
            # print(title)
            # print(kind)
            ...
            # print(title[0].extract_first())
            # print(kind[4].extract_first())
            # print(time[1].extract_first())
            # print(title[0].extract_first().strip())
            # print(kind[4].extract_first().strip())
            # print(time[1].extract_first().strip())
            #
